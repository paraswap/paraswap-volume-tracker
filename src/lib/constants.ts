...
export const STAKING_CHAIN_IDS = [CHAIN_ID_MAINNET, CHAIN_ID_ROPSTEN, CHAIN_ID_OPTIMISM];
export const ETH_NETWORKS = [CHAIN_ID_MAINNET, CHAIN_ID_ROPSTEN, CHAIN_ID_GOERLI];
